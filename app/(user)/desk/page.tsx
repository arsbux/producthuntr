            ...
            <div className="bg-white dark:bg-hunted-card rounded-xl border border-gray-200 dark:border-hunted-border p-4 sm:p-6 mb-6 sm:mb-8">
              ...
              {loadingToday ? (
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
                  {[1, 2, 3].map((i) => (
                    <div key={i} className="h-20 bg-gray-100 dark:bg-hunted-card rounded-xl animate-pulse" />
                  ))}
                </div>
              ) : (
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
                  {/* Total Launches Card */}
                  <div className="bg-white dark:bg-hunted-card border border-gray-100 dark:border-hunted-border rounded-xl p-4 flex items-center justify-between shadow-sm hover:shadow-md transition-shadow">
                    <div>
                      <p className="text-xs text-gray-500 dark:text-hunted-muted font-medium mb-1">Total Launches</p>
                      <h3 className="text-2xl font-bold text-gray-900 dark:text-hunted-text">{todayData?.metrics?.totalLaunches || 0}</h3>
                    </div>
                  ...
                  <div className="bg-white dark:bg-hunted-card border border-gray-100 dark:border-hunted-border rounded-xl p-4 flex items-center justify-between shadow-sm hover:shadow-md transition-shadow">
                    <div>
                      <p className="text-xs text-gray-500 dark:text-hunted-muted font-medium mb-1">AI Saturation</p>
                      <h3 className="text-2xl font-bold text-gray-900 dark:text-hunted-text">{todayData?.metrics?.aiPercentage || 0}%</h3>
                    </div>
                  ...
                  <Link href="/desk/niche/AI%20%26%20Machine%20Learning" className="group">
                    <div className="h-full bg-white dark:bg-hunted-card border border-gray-100 dark:border-hunted-border rounded-xl p-4 flex items-center justify-between shadow-sm hover:border-blue-500 dark:hover:border-blue-500 transition-colors cursor-pointer">
                      <div>
                        <h3 className="text-sm font-bold text-gray-900 dark:text-hunted-text group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">Analyze AI Trends</h3>
                        <p className="text-xs text-gray-500 dark:text-hunted-muted mt-0.5">Deep dive into AI products</p>
                      </div>
                      <div className="w-8 h-8 rounded-full bg-gray-50 dark:bg-hunted-border flex items-center justify-center group-hover:bg-blue-50 dark:group-hover:bg-blue-900/30 transition-colors">
                      ...
                      <>
                        <ResponsiveContainer width="100%" height="100%">
                          ...
                          >
                            ...
                            {/* Legend as Category Markers */}
                            <Legend
                              iconSize={10}
                              layout="vertical"
                              verticalAlign="middle"
                              align="right"
                              wrapperStyle={{ right: 0, fontSize: '11px', lineHeight: '24px' }}
                              formatter={(value, entry: any) => (
                                <span className="text-gray-600 dark:text-hunted-text font-medium ml-1">
                                  {value} <span className="text-gray-400 dark:text-hunted-muted font-normal">({entry.payload.value})</span>
                                </span>
                              )}
                            />
