...
export default function DashboardPage() {
  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-[calc(100vh-64px)] bg-gray-50 dark:bg-black">
      {/* LEFT SIDEBAR - Categories List */}
      <aside className="w-full lg:w-96 bg-white dark:bg-gray-900 border-b lg:border-b-0 lg:border-r border-gray-200 dark:border-gray-800 flex-shrink-0 h-auto lg:h-[calc(100vh-64px)] overflow-y-auto lg:sticky lg:top-16">
        <div className="p-4 sticky top-0 bg-white dark:bg-gray-900 z-10 border-b border-gray-100 dark:border-gray-800">
          <div className="flex items-center justify-between">
            <h2 className="text-base font-bold text-gray-900 dark:text-white">All Categories</h2>
            <span className="text-xs text-gray-500 dark:text-gray-400 font-semibold bg-gray-100 dark:bg-gray-800 px-2.5 py-1 rounded-full">
            ...
            topCategories.map((category, index) => {
              ...
              return (
                <Link
                  ...
                  className={`${gradient} dark:from-gray-800 dark:to-gray-800 dark:border-gray-700 p-3 rounded-xl border border-white/50 shadow-sm hover:shadow-md transition-all flex flex-col gap-2 group`}
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      {/* Name */}
                      <h3 className="text-sm font-bold text-gray-900 dark:text-gray-200 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors truncate max-w-[180px]">
                        {category.category}
                      </h3>
                    </div>

                    {/* Launch Count Badge */}
                    <span className="text-xs font-bold text-gray-700 dark:text-gray-300 bg-white/60 dark:bg-gray-700/50 px-2 py-1 rounded-md shadow-sm border border-white/50 dark:border-gray-600">
                      {category.launches}
                    </span>
                  </div>
      ...
      <main className="flex-1">
        <div className="p-6 space-y-6">
          ...
          {/* TODAY'S LIVE PULSE */}
          {todayData && (
            <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-4 sm:p-6 mb-6 sm:mb-8">
              {/* Header Section */}
              ...
              {loadingToday ? (
                <div className="flex flex-wrap gap-2 mb-4 sm:mb-6">
                  <div className="h-10 sm:h-12 w-28 sm:w-32 bg-gray-100 dark:bg-gray-800 rounded-lg animate-pulse" />
                  <div className="h-10 sm:h-12 w-20 sm:w-24 bg-gray-100 dark:bg-gray-800 rounded-lg animate-pulse" />
                  <div className="h-10 sm:h-12 flex-1 min-w-[140px] bg-gray-100 dark:bg-gray-800 rounded-lg animate-pulse" />
                </div>
              ) : (
                <div className="flex flex-wrap items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
                  <div className="px-4 py-2.5 sm:py-3 bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-100 rounded-xl">
                    ...
                    <div className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white">{todayData?.metrics?.totalLaunches || 0}</div>
                  </div>
                  <div className="px-4 py-2.5 sm:py-3 bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 border border-purple-100 dark:border-purple-900/30 rounded-xl">
                    ...
                    <div className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white">{todayData?.metrics?.aiPercentage || 0}%</div>
                  </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-start">
                ...
                <div className="bg-white dark:bg-gray-900 rounded-xl lg:col-span-2 border border-gray-100 dark:border-gray-800 shadow-sm overflow-hidden">
                  <div className="p-3 border-b border-gray-100 dark:border-gray-800 bg-gray-50/50 dark:bg-gray-800/50">
                    <div className="flex items-center justify-between">
                      <h3 className="font-bold text-gray-900 dark:text-white text-base">Top 10 products</h3>
                  ...
                  {loadingToday ? (
                    <div className="p-2 space-y-2">
                      {[1, 2, 3, 4, 5].map((i) => (
                        <div key={i} className="bg-gray-50 dark:bg-gray-800 p-2 rounded-lg flex items-center gap-3 animate-pulse h-12">
                          <div className="w-8 h-8 bg-gray-200 dark:bg-gray-700 rounded" />
                          <div className="flex-1 h-3 bg-gray-200 dark:bg-gray-700 rounded w-1/2" />
                      ...
                      {todayData?.topLaunches?.slice(0, 10).map((launch, index) => {
                        ...
                        return (
                          <Link key={launch.name} href={`/desk/idea-validator?product=${launch.id}`}>
                            <div className={`${gradient} dark:from-gray-800 dark:to-gray-800 dark:border-gray-700 py-2 px-3 rounded-lg border border-white/50 shadow-sm hover:shadow-md transition-all flex items-center gap-3 group cursor-pointer`}>
                              {/* Rank & Icon Container */}
                              <div className="relative flex-shrink-0">
                                <span className="absolute -top-1 -left-1 text-[10px] font-bold text-gray-500 dark:text-gray-400 w-4 h-4 flex items-center justify-center bg-white/80 dark:bg-gray-700 rounded-full shadow-sm z-10">
                                  {index + 1}
                                </span>
                                {launch.thumbnail_url ? (
                                  <img src={launch.thumbnail_url} alt={launch.name} className="w-10 h-10 rounded-lg object-cover shadow-sm" />
                                ) : (
                                  <div className="w-10 h-10 rounded-lg bg-white/50 dark:bg-gray-700 flex items-center justify-center text-gray-400 shadow-sm">
                              ...
                              {/* Name */}
                              <div className="flex-1 min-w-0">
                                <h4 className="text-sm font-bold text-gray-900 dark:text-gray-200 truncate group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">{launch.name}</h4>
                              </div>

                              {/* Metrics Columns - Aligned with Header */}
                              <div className="flex items-center gap-6 text-xs font-bold text-gray-900 dark:text-gray-300">
                ...
                {/* Category Chart */}
                <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-4 lg:col-span-3">
                  <h3 className="font-bold text-gray-900 dark:text-white text-sm mb-4">Category Split</h3>
          ...
          <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-6">
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Historical launch volume trends</p>
              </div>
            </div>
            <div className="h-96">
              {loadingCategories ? (
                <div className="w-full h-full bg-gray-50 dark:bg-gray-800 rounded-lg animate-pulse flex items-center justify-center">
              ...
              <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div>
                  <div className="flex items-center gap-2 mb-3 pb-2 border-b border-gray-100">
                    ...
                    <div className="flex-1">
                      <span className="font-bold text-sm text-gray-900 dark:text-white">Blue Ocean</span>
                  ...
                  <div className="space-y-1">
                    {quadrants['blue-ocean'].slice(0, 5).map(item => (
                      ...
                      >
                        <span className="text-xs text-gray-700 dark:text-gray-300 font-medium group-hover:text-blue-600 dark:group-hover:text-blue-400 truncate">{item.category}</span>
                ...
                <div>
                  <div className="flex items-center gap-2 mb-3 pb-2 border-b border-gray-100">
                    ...
                    <div className="flex-1">
                      <span className="font-bold text-sm text-gray-900 dark:text-white">Red Ocean</span>
                ...
                <div>
                  <div className="flex items-center gap-2 mb-3 pb-2 border-b border-gray-100">
                    ...
                    <div className="flex-1">
                      <span className="font-bold text-sm text-gray-900 dark:text-white">Emerging</span>
                ...
                <div>
                  <div className="flex items-center gap-2 mb-3 pb-2 border-b border-gray-100">
                    ...
                    <div className="flex-1">
                      <span className="font-bold text-sm text-gray-900 dark:text-white">Niche</span>
