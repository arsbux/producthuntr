...
export default function Navbar() {
    ...
    return (
        ...
        >
            ...
            {/* Mobile Menu */}
            {mobileMenuOpen && (
                <div className="md:hidden absolute top-20 left-0 w-full bg-[#0A0A0C] border-b border-white/10 p-6 flex flex-col gap-4 shadow-2xl">
                    <Link
                        href="#pricing"
                    ...
                    <Link
                        href="/pricing"
                        className="bg-[#FF6154] hover:bg-[#ff4f40] text-white px-5 py-3 rounded-xl text-center font-bold mt-2"
                        onClick={() => setMobileMenuOpen(false)}
                    >
                        Get Started
                    </Link>
