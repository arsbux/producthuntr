...
export default function CategoryProfile({ data }: { data: CategoryDetails }) {
    ...
    return (
        <div className="p-8 bg-gray-50 dark:bg-hunted-dark min-h-screen font-sans">
            <div className="max-w-7xl mx-auto space-y-8">
                <div className="flex justify-between items-start">
                    <div>
                        <h1 className="text-3xl font-bold text-gray-900 dark:text-hunted-text">{data.topic}</h1>
                        <p className="text-gray-500 dark:text-hunted-muted">Detailed analysis and trends.</p>
                    </div>
                    <Link
                ...
                {/* Growth Trend */}
                <div className="bg-white dark:bg-hunted-card p-6 rounded-xl border border-gray-100 dark:border-hunted-border shadow-sm">
                    <h2 className="text-xl font-bold mb-4 text-gray-900 dark:text-hunted-text">Growth Trend</h2>
                    <p className="text-sm text-gray-500 dark:text-hunted-muted mb-6">Launch volume, upvotes, and comments over the last 12 months</p>
                    <div className="h-96">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    {/* Top Keywords */}
                    <div className="bg-white dark:bg-hunted-card p-6 rounded-xl border border-gray-100 dark:border-hunted-border shadow-sm">
                        <h2 className="text-xl font-bold mb-4 text-gray-900 dark:text-hunted-text">Top Keywords</h2>
                        <p className="text-sm text-gray-500 dark:text-hunted-muted mb-6">Most frequently used terms in this category</p>
                        <div className="h-96">
                            <ResponsiveContainer width="100%" height="100%">
                    ...
                    {/* Keyword Trends */}
                    <div className="bg-white dark:bg-hunted-card p-6 rounded-xl border border-gray-100 dark:border-hunted-border shadow-sm">
                        <h2 className="text-xl font-bold mb-4 text-gray-900 dark:text-hunted-text">Keyword Trends</h2>
                        <p className="text-sm text-gray-500 dark:text-hunted-muted mb-6">Usage frequency of top keywords over time</p>
                        <div className="h-96">
                            <ResponsiveContainer width="100%" height="100%">
